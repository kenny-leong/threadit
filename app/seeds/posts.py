...
def seed_posts():
    ...
    posts = [
        Post(title='Genshin Impact addiction— Gamer spends $40,000 on gacha characters', content='...', author=users[0], image_url="https://assets.reedpopcdn.com/Genshin-Impact-beginner%E2%80%99s-guide-for-2023%2C-tips-and-tricks-cover.jpg/BROK/thumbnail/1200x1200/quality/100/Genshin-Impact-beginner%E2%80%99s-guide-for-2023%2C-tips-and-tricks-cover.jpg", subreddit=subreddits[0], created_at=datetime.utcnow()),
        Post(title='How to optimize your code', content='...', author=users[1], subreddit=subreddits[1], image_url="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQNBT-Wz76dPt9P4cgQWKivlxu0JmRWt-XNvQ&usqp=CAU", created_at=datetime.utcnow()),
        Post(title='Interesting article about Python', content='...', author=users[2], subreddit=subreddits[1], image_url="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSU4gC8xkvp-odMTzHXrh9T32QFrSf5wDnPGQ&usqp=CAU", created_at=datetime.utcnow()),
        Post(title='The future of artificial intelligence: What can we expect?', content='...', author=users[3], image_url="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTcK5tjrpXAkkT1XTjkAxQhmDipkrlgPtsNQQ&usqp=CAU", subreddit=subreddits[0], created_at=datetime.utcnow()),
        Post(title='Whats your favorite book and why?', content='...', author=users[4], subreddit=subreddits[1], image_url="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRMEt8TfO7znM19ZgZM2lGTek_VligYe587SQ&usqp=CAU", created_at=datetime.utcnow()),
        Post(title='Best travel destinations for adventure seekers', content='...', author=users[5], subreddit=subreddits[1], image_url="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRCeju03n7p4g8UVAECZhx2zY6ukEnHAhMOBA&usqp=CAU", created_at=datetime.utcnow()),
        Post(title='The dark side of social media: How it affects mental health', content='...', author=users[6], subreddit=subreddits[0], image_url="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSKWdWWXf765QA-iOG_GHxeebI51QWS8T6BhQ&usqp=CAU", created_at=datetime.utcnow()),
