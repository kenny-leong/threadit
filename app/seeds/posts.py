...
def seed_posts():
    ...
    posts = [
        ...
        Post(title='Genshin Impact addiction— Gamer spends $40,000 on gacha characters', author=users[0], image_url="https://assets.reedpopcdn.com/Genshin-Impact-beginner%E2%80%99s-guide-for-2023%2C-tips-and-tricks-cover.jpg/BROK/thumbnail/1200x1200/quality/100/Genshin-Impact-beginner%E2%80%99s-guide-for-2023%2C-tips-and-tricks-cover.jpg", subreddit=subreddits[6], created_at=datetime.utcnow()),
