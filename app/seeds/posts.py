...
def seed_posts():
    ...
    posts = [
        ...
        Post(title='Has Bitcoin Benefited From the Banking Crisis? Not in the Way Its Fans Hoped.', author=users[0], subreddit=subreddits[14], image_url='https://static01.nyt.com/images/2023/03/31/business/31bitcoin/31bitcoin-superJumbo.jpg?quality=75&auto=webp', created_at=datetime.utcnow()),
